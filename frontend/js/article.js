                ...
                for (let jsonArticle of jsonListArticle) {
                    ...
                    for (let link of linksToArticle) {
                        link.addEventListener("click", function(e) {
                            ...
                            article.getArticleById2(this.dataset.id);
                        });
                    };
                };
                goToHomeBtns();
        ...
        .then(article => {
            ...
            if (idInUrl) {
                ...
                <div id="article-unique">
                    ...
                    <p class="text-end m-5 card-link">
                        <a id="home-btn" data-link="home" class="text-decoration-none text-reset" href="http://127.0.0.1:5500/frontend/view/index.html">
                            < Retourner vers l'accueil
                        </a>
                    </p>
                </div>
